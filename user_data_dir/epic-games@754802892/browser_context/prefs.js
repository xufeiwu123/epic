...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1729117925);
user_pref("app.update.lastUpdateTime.background-update-timer", 1729117925);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1729117925);
user_pref("app.update.lastUpdateTime.region-update-timer", 1729031544);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1729117925);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1726420958);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1729117925);
...
user_pref("browser.contextual-services.contextId", "{6d0e5b5e-e36d-484d-a942-d45439fed38e}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{f74bfa4e-b80e-4e02-a389-2088cefc5d25}");
...
user_pref("browser.startup.lastColdStartupCheck", 1729117896);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIX6z3+ngI+cBAgPDTyOWWCmZA==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"d107f3a4-5bda-4a1b-8cfa-cd8553e919e6\",\"pictureinpicture@mozilla.org\":\"c361413e-4be6-4c78-83ae-9a23e6861682\",\"screenshots@mozilla.org\":\"308fb9a1-ce04-459d-ad9a-7ae5d9b133b6\",\"webcompat-reporter@mozilla.org\":\"138422c9-b4e4-4358-91ce-777acaded6a3\",\"webcompat@mozilla.org\":\"5c811cd8-930d-4adc-b847-1e0840c41223\",\"default-theme@mozilla.org\":\"43cdb836-2373-4c86-98f6-bf9931fa723e\",\"addons-search-detection@mozilla.com\":\"fa9b8d24-68a9-4310-b8e7-0e01d34c2c8f\"}");
...
user_pref("media.gmp-manager.lastCheck", 1729117921);
user_pref("media.gmp-manager.lastEmptyCheck", 1729117921);
...
user_pref("security.sandbox.content.tempDirSuffix", "635c81cb-f1ef-428f-b8bc-c7030a4ac961");
user_pref("security.sandbox.warn_unprivileged_namespaces", false);
user_pref("services.settings.server", "");
user_pref("signon.autofillForms", false);
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECJPLhHJHwjU0BAgAByVVkvp/hQ==");
user_pref("signon.rememberSignons", false);
user_pref("startup.homepage_welcome_url", "about:blank");
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1729117895);
